...
const delete_products_categories_menu = async (chat_id, options, token) => {
  try {
    const {} = options;
    const data = JSON.stringify({
      ...
      reply_markup: {
        keyboard: [
          ...
          [
            {
              text: "Обрати дану категорію, товар якої ви хочете деактивувати",
            },
          ],
          [{ text: "<< Назад" }],
...
module.exports = { delete_products_categories_menu };

...
const main_menu_after_start = async (receiver, options, token) => {
  try {
    const {} = options;
    const data = JSON.stringify({
      ...
      type: "text",
      text:
        "Вітаємо, відтерер ви з нами. \n\nВикористовуй клавіатуру нижче, щоб вибрати необхідну команду 👇",
      keyboard: {
        DefaultHeight: false,
...
module.exports = { main_menu_after_start };
